#ifndef __LYSLG_MODULE_H__
#define __LYSLG_MODULE_H__
...
public:
    ...
    virtual bool onConnect(lyslg::Stream::ptr stream);
    virtual bool onDisconnect(lyslg::Stream::ptr stream);
...
typedef lyslg::Singleton<ModuleManager> ModuleMgr;
