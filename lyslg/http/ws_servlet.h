...
public:
    ...
    virtual int32_t handle(lyslg::http::HttpRequest::ptr request
                   , lyslg::http::HttpResponse::ptr response
                   , lyslg::http::HttpSession::ptr session) override {
        return 0;
    }

    virtual int32_t onConnect(lyslg::http::HttpRequest::ptr header
                              ,lyslg::http::WSSession::ptr session) = 0;
...
public:
    ...
    typedef std::function<int32_t (lyslg::http::HttpRequest::ptr header
                              ,lyslg::http::WSSession::ptr session)> on_connect_cb;
    typedef std::function<int32_t (lyslg::http::HttpRequest::ptr header
                             ,lyslg::http::WSSession::ptr session)> on_close_cb; 
    typedef std::function<int32_t (lyslg::http::HttpRequest::ptr header
                           ,lyslg::http::WSFrameMessage::ptr msg
                           ,lyslg::http::WSSession::ptr session)> callback;
