...
// int32_t Servlet::handle(HttpRequest::ptr  reques ,HttpResponse::ptr response
...
ServletDispatch::ServletDispatch()
    ...
    m_default.reset(new NotFoundServlet("lyslg/1.0"));
}
...
int32_t NotFoundServlet::handle(HttpRequest::ptr  request, HttpResponse::ptr response
    ...
    response->setHeader("Server", "lyslg/1.0.0");
